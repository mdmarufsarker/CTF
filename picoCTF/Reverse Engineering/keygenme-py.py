...
'''notes:
# license: picoCTF{1n_7h3_|<3y_of_xxxxxxxx}
# license: picoCTF{1n_7h3_|<3y_of_0d208392}
...
data = hashlib.sha256(bUsername_trial).hexdigest()
print(data) 
# 09820d032d73c31bd8f4a0532062a239d828a4da0951aeb66da928e843597e35

print(data[4] + data[5] + data[3] + data[6] + data[2] + data[7] + data[1] + data[8])
# 0d208392
